...
<%-- <script type='text/javascript' src='<c:url value='/resources/js/jquery.1.10.2.min.js' />'></script> --%>
	...
	var contexPath = "<%=request.getContextPath() %>/modelo";
    ...
    function edit(idVal){
    	...
    	var successFunction = function(response){
       		if(response.status=="OK"){
       			...
       			$("#marcaId").val(response.viewBean.marca.id);
...
<thead>
<tr><th>Id</th><th>Marca</th><th>Descripsion</th><th>Actions</th></tr>  
</thead>
</table>
		...
		<div class="form-container">
		        ...
		        <form class="form-horizontal">
				  <div class="form-group">
					    ...
					    <div class="col-sm-7">
					      <select id="marcaId" class="form-control input-sm">
