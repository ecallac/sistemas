...
public class RoleIntegration extends ServiceIntegrationAbstract<Role> {
	...
	public void savePermissionAssociation(Role bean,Long moduleId) {
		setObjectToPostRequest(appsecurityapi+"/"+basePath+"/saveRolePermissionAssociation?moduleId="+moduleId, bean);
	}
}
