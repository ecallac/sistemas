<%@ page import="com.internal.web.controller.AreaController" %>
...
<head>
	...
	<script type="text/javascript">
		...
		var controllerName = "<%=AreaController.NAME %>";
		...
		function load(){
			...
			var parentAreaId = $('#parentAreaIdSearch').val();
		...
		<div class="card flex-fill">
			...
			<div class="card-body">
				<table id="table" align="center" class="table table-striped table-sm table-hover" style="width: 100%">
					<thead>
					<tr><th></th><th>Nombre</th><th>Parent</th><th>Estado</th><th>Acciones</th></tr>
					</thead>
				</table>
			</div>
		</div>
			...
			<div class="modal-body">
				...
				<div class="form-container">
					...
					<form class="form-horizontal">
						...
						<div class="mb-3 row">
							<label for="parentAreaIdSearch" class="col-sm-3 col-form-label">Parent</label>
							<div class="col-sm-7">
								<select id="parentAreaIdSearch" class="form-control input-sm selectFilter">
									<option value="">-- Seleccionar --</option>
								</select>
							</div>
						</div>
