<%@ page import="com.internal.web.controller.MarcaController" %>
...
<head>
	...
	<script type="text/javascript">
		...
		var controllerName = "<%=MarcaController.NAME %>";
		...
		<div class="card flex-fill">
			...
			<div class="card-body">
				<table id="table" align="center" class="table table-striped table-sm table-hover" style="width: 100%">
					<thead>
					<tr><th></th><th>Nombre</th><th>Descripcion</th><th>Estado</th><th>Acciones</th></tr>
					</thead>
				</table>
			</div>
		</div>
