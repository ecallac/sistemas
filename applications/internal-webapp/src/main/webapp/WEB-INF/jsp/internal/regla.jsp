<%@ page import="com.internal.web.controller.ReglaController" %>
...
<head>
	...
	<script type="text/javascript">
		...
		var controllerName = "<%=ReglaController.NAME %>";
		...
		function setFormFieldsFromServiceResponse(response){
			...
			$('#tipoValor').val(response.viewBean.tipoValor);
		...
		function verifyCodigo(object){
			verifyField(controllerName,'verifyCodigo','codigo',object.id,object.value);
		}
				...
				},
				{
					...
					"render": function ( data, type, row ) {
						...
						return "<td>"+
								...
								value+
								makeButton("Administrar Detalle","manageDetail("+row.id+")","",imgList)+
								"</td>" ;
		...
		function manageDetail(id){
			window.location.href = contexPath+"/reglaDetalle?reglaId="+id;
		}
		...
		<div class="card flex-fill">
			...
			<div class="card-body">
				<table id="table" align="center" class="table table-striped table-sm table-hover" style="width: 100%">
					<thead>
					<tr><th></th><th>Categoria</th><th>Codigo</th><th>Tipo de Valor</th><th>Nombre</th><th>Descripcion</th><th>Estado</th><th>Acciones</th></tr>
					</thead>
				</table>
			</div>
		</div>
				...
				<div class="form-container">
					...
					<form class="form-horizontal">
						...
						<div class="mb-3 row">
							...
							<div class="col-sm-7">
								<input type="text" class="form-control onlyText" id="categoria" placeholder="Categoria">
							</div>
						</div>
						<div class="mb-3 row">
							<label for="codigo" class="col-sm-3 col-form-label">Codigo</label>
							<div class="col-sm-7">
								<input type="text" class="form-control onlyText" id="codigo" placeholder="Codigo" onchange="verifyCodigo(this);">
							</div>
						</div>
						<div class="mb-3 row">
							<label for="tipoValor" class="col-sm-3 col-form-label">Tipo de Valor</label>
							<div class="col-sm-7">
								<input type="text" class="form-control onlyText" id="tipoValor" placeholder="Tipo de Valor">
							</div>
						</div>
						<div class="mb-3 row">
